...
5. **Import and export**: Import past training from Excel files. Export saved sessions as standard CSV, and back up or restore all data with a backup file. Photograph or select an InBody report and it is recognized and recorded on the device.
