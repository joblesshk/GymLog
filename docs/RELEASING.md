...
1. Use the latest clean main checkout. Run repository privacy checks, synthetic tests and app build. Recheck third-party licenses and changed data flows.
2. Choose your own bundle identifiers and Apple signing team. Do not commit signing identities, certificates, provisioning profiles or App Store Connect API keys.
